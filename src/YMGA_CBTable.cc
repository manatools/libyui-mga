...
bool
YMGA_CBTable::hasColumn( int column ) const
{
...
std::string
YMGA_CBTable::header( int column ) const
{
...
YAlignmentType
YMGA_CBTable::alignment( int column ) const
{
...
bool
YMGA_CBTable::immediateMode() const
{
...
void
YMGA_CBTable::setImmediateMode( bool immediateMode )
{
...
bool
YMGA_CBTable::keepSorting() const
{
...
void
YMGA_CBTable::setKeepSorting( bool keepSorting )
{
...
bool
YMGA_CBTable::hasMultiSelection() const
{
...
bool
YMGA_CBTable::setProperty( const std::string & propertyName, const YPropertyValue & val )
{
...
YPropertyValue
YMGA_CBTable::getProperty( const std::string & propertyName )
{
